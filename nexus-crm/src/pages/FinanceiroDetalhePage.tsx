...
export default function FinanceiroDetalhePage() {
  ...
  const statusLabel = cobranca.status == null ? 'Não informado' : cobranca.status === 'ATIVA' ? 'Ativa' : cobranca.status === 'QUITADA' ? 'Quitada' : 'Cancelada'
