...
## Repository map
- `download_stitch_screens.ps1/` — explain what lives here and when agents should edit it.
- `nexus-crm/` — explain what lives here and when agents should edit it.
- `package-lock.json/` — explain what lives here and when agents should edit it.
- `stitch_screens/` — explain what lives here and when agents should edit it.
